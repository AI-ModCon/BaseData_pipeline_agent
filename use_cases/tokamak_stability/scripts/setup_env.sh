...
# MPI, HDF5, and LAPACK. On macOS: brew install cmake pkgconf gcc open-mpi hdf5
# (LAPACK comes with Accelerate). On Debian/Ubuntu: apt install cmake pkg-config
# gfortran libopenmpi-dev libhdf5-dev liblapack-dev.
set -euo pipefail
